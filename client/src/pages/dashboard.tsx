            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto">
              ...
              <div className="group p-12 rounded-3xl border border-white/10 bg-white/5 hover:border-[#FFE500]/50 hover:bg-[#FFE500]/5 transition-all duration-300 text-center flex flex-col items-center">
                 ...
                 <div className="mt-auto">
                    <Button
                      variant="outline"
                      className="rounded-full px-8 py-2 border-white/20 text-white hover:bg-[#FFE500] hover:text-black hover:border-[#FFE500] transition-all font-bold text-sm tracking-widest uppercase bg-transparent h-auto"
                    >
                      LEARN MORE
                    </Button>
                 </div>
